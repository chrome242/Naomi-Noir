    <div class="container" id="news">
        <div class= "row">
            ...
            <div class="col-md-12" id="hidden_hr">
                <hr>
                <h2>Naomi Noir Elsewhere</h2>
            </div>
            
            <div class="col-md-4" id="social">
                
                <h2><a href="mailto:contact@naominoir.com"><i class="fa fa-envelope fa-2x"></i></a> Find out More</h2>
                <div class="btn-group">
                    <a class="btn" id="facebook" href="https://www.facebook.com/NaomiNoirProductions" target="_blank"><i class="fa fa-facebook-square fa-3x"></i></a>
                    <a class="btn" id="youTube" href="https://www.youtube.com/channel/UC5ZdV05FRclH_cZavsBBD_A" target="_blank"><i class="fa fa-youtube-square fa-3x"></i></a>
                    <a class="btn" id="vine" href="http://vimeo.com/naominoir" target="_blank"><i class="fa fa-vimeo-square fa-3x"></i></a>
                    <a class="btn" id="linkedIn" href="https://www.linkedin.com/pub/naomi-noir/42/597/19b" target="_blank"><i class="fa fa-linkedin-square fa-3x"></i></a>
                    
                </div>
                <br>
                
                <img src="images/index/NaomiNoirbusinesscard1back.png" alt="Business Logo Back">
            </div>
